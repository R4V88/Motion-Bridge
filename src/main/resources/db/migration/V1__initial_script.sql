...
create table product (id int8 not null, uuid varchar(255), version int8, animation_quantity int4, background varchar(255), created_at timestamp, currency varchar(255), is_active boolean, price numeric(19, 2), time_period varchar(255), title varchar(255), type varchar(255), updated_at timestamp, primary key (id));
